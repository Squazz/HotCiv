    ...
    public class WorldLayoutStrategyDeltaWorld : IWorldLayoutStrategy
    {
        public Dictionary<Position, ITile> CreateTiles()
        {
            Dictionary<Position, ITile> tiles = new Dictionary<Position, ITile>
            {
                ...
                {new Position(9, 8), new Tile(GameConstants.Ocean)},
                {new Position(9, 9), new Tile(GameConstants.Ocean)},
                {new Position(9, 10), new Tile(GameConstants.Ocean)},
                {new Position(10, 10), new Tile(GameConstants.Ocean)},
                {new Position(10, 11), new Tile(GameConstants.Ocean)},
                {new Position(10, 12), new Tile(GameConstants.Ocean)},
                ...
                {new Position(6, 10), new Tile(GameConstants.Hills)},
                {new Position(7, 9), new Tile(GameConstants.Hills)},
